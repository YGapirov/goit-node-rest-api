...
const { createContactSchema, updateFavoriteSchema } = require("../schemas/contactsSchemas.js");
...
contactsRouter.put("/:id", authMiddleware, validateBody(createContactSchema), updateContact);
contactsRouter.patch("/:id/favorite", authMiddleware, isValidId, validateBody(updateFavoriteSchema), updateStatusContact);
